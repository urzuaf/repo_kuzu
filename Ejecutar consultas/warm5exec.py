...
def processQueries(queries):
    ...
    print("ejecutando: ")
    print(queries)
    command = f"echo \" call timeout = {timeout};"+  queries * 6 + " \" | " + kuzu_path + " --no_progress_bar -m trash"
    ...
    for values in column_values:
        if values[0] != "Buffer" and values[0] != "Interrupted":  # Si la columna tiene valores numéricos
